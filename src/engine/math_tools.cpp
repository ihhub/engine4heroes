...
double engine4heroes::GetAngle( const Point & start, const Point & target )
{
...
std::vector<engine4heroes::Point> engine4heroes::getLinePoints( const Point & pt1, const Point & pt2, const uint32_t step )
{
...
std::vector<engine4heroes::Point> engine4heroes::GetArcPoints( const Point & from, const Point & to, const int32_t arcHeight, const int32_t step )
{
...
int32_t engine4heroes::GetRectIndex( const std::vector<Rect> & rects, const Point & pt )
{
...
engine4heroes::Rect engine4heroes::getBoundaryRect( const Rect & rt1, const Rect & rt2 )
{
