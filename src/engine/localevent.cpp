...
namespace
{
    ...
    char getCharacterFromPressedKey( const engine4heroes::Key key, int32_t mod )
    {
        if ( ( mod & engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT ) && ( mod & engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) ) {
            mod = mod & ~( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS );
        }

        switch ( key ) {
        case engine4heroes::Key::KEY_1:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '!' : '1' );
        case engine4heroes::Key::KEY_2:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '@' : '2' );
        case engine4heroes::Key::KEY_3:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '#' : '3' );
        case engine4heroes::Key::KEY_4:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '$' : '4' );
        case engine4heroes::Key::KEY_5:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '%' : '5' );
        case engine4heroes::Key::KEY_6:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '^' : '6' );
        case engine4heroes::Key::KEY_7:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '&' : '7' );
        case engine4heroes::Key::KEY_8:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '*' : '8' );
        case engine4heroes::Key::KEY_9:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '(' : '9' );
        case engine4heroes::Key::KEY_0:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? ')' : '0' );
        case engine4heroes::Key::KEY_KP_0:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '0';
            break;
        case engine4heroes::Key::KEY_KP_1:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '1';
            break;
        case engine4heroes::Key::KEY_KP_2:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '2';
            break;
        case engine4heroes::Key::KEY_KP_3:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '3';
            break;
        case engine4heroes::Key::KEY_KP_4:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '4';
            break;
        case engine4heroes::Key::KEY_KP_5:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '5';
            break;
        case engine4heroes::Key::KEY_KP_6:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '6';
            break;
        case engine4heroes::Key::KEY_KP_7:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '7';
            break;
        case engine4heroes::Key::KEY_KP_8:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '8';
            break;
        case engine4heroes::Key::KEY_KP_9:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '9';
            break;
        case engine4heroes::Key::KEY_KP_PERIOD:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '.';
            break;
        case engine4heroes::Key::KEY_KP_DIVIDE:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '/';
            break;
        case engine4heroes::Key::KEY_KP_MULTIPLY:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '*';
            break;
        case engine4heroes::Key::KEY_KP_MINUS:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '-';
            break;
        case engine4heroes::Key::KEY_KP_PLUS:
            if ( engine4heroes::KeyModifier::KEY_MODIFIER_NUM & mod )
                return '+';
            break;
        case engine4heroes::Key::KEY_MINUS:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '_' : '-' );
        case engine4heroes::Key::KEY_EQUALS:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '+' : '=' );
        case engine4heroes::Key::KEY_BACKSLASH:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '|' : '\\' );
        case engine4heroes::Key::KEY_LEFT_BRACKET:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '{' : '[' );
        case engine4heroes::Key::KEY_RIGHT_BRACKET:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '}' : ']' );
        case engine4heroes::Key::KEY_SEMICOLON:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? ':' : ';' );
        case engine4heroes::Key::KEY_QUOTE:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '"' : '\'' );
        case engine4heroes::Key::KEY_COMMA:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '<' : ',' );
        case engine4heroes::Key::KEY_PERIOD:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '>' : '.' );
        case engine4heroes::Key::KEY_SLASH:
            return ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT & mod ? '?' : '/' );
        case engine4heroes::Key::KEY_EXCLAIM:
            return '!';
        case engine4heroes::Key::KEY_AT:
            return '@';
        case engine4heroes::Key::KEY_HASH:
            return '#';
        case engine4heroes::Key::KEY_DOLLAR:
            return '$';
        case engine4heroes::Key::KEY_AMPERSAND:
            return '&';
        case engine4heroes::Key::KEY_ASTERISK:
            return '*';
        case engine4heroes::Key::KEY_LEFT_PARENTHESIS:
            return '(';
        case engine4heroes::Key::KEY_RIGHT_PARENTHESIS:
            return ')';
        case engine4heroes::Key::KEY_DOUBLE_QUOTE:
            return '"';
        case engine4heroes::Key::KEY_PLUS:
            return '+';
        case engine4heroes::Key::KEY_COLON:
            return ':';
        case engine4heroes::Key::KEY_LESS:
            return '<';
        case engine4heroes::Key::KEY_GREATER:
            return '>';
        case engine4heroes::Key::KEY_QUESTION:
            return '?';
        case engine4heroes::Key::KEY_CARET:
            return '^';
        case engine4heroes::Key::KEY_UNDERSCORE:
            return '_';
        case engine4heroes::Key::KEY_SPACE:
            return ' ';
        case engine4heroes::Key::KEY_A:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'A' : 'a' );
        case engine4heroes::Key::KEY_B:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'B' : 'b' );
        case engine4heroes::Key::KEY_C:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'C' : 'c' );
        case engine4heroes::Key::KEY_D:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'D' : 'd' );
        case engine4heroes::Key::KEY_E:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'E' : 'e' );
        case engine4heroes::Key::KEY_F:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'F' : 'f' );
        case engine4heroes::Key::KEY_G:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'G' : 'g' );
        case engine4heroes::Key::KEY_H:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'H' : 'h' );
        case engine4heroes::Key::KEY_I:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'I' : 'i' );
        case engine4heroes::Key::KEY_J:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'J' : 'j' );
        case engine4heroes::Key::KEY_K:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'K' : 'k' );
        case engine4heroes::Key::KEY_L:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'L' : 'l' );
        case engine4heroes::Key::KEY_M:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'M' : 'm' );
        case engine4heroes::Key::KEY_N:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'N' : 'n' );
        case engine4heroes::Key::KEY_O:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'O' : 'o' );
        case engine4heroes::Key::KEY_P:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'P' : 'p' );
        case engine4heroes::Key::KEY_Q:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'Q' : 'q' );
        case engine4heroes::Key::KEY_R:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'R' : 'r' );
        case engine4heroes::Key::KEY_S:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'S' : 's' );
        case engine4heroes::Key::KEY_T:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'T' : 't' );
        case engine4heroes::Key::KEY_U:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'U' : 'u' );
        case engine4heroes::Key::KEY_V:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'V' : 'v' );
        case engine4heroes::Key::KEY_W:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'W' : 'w' );
        case engine4heroes::Key::KEY_X:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'X' : 'x' );
        case engine4heroes::Key::KEY_Y:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'Y' : 'y' );
        case engine4heroes::Key::KEY_Z:
            return ( ( engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT | engine4heroes::KeyModifier::KEY_MODIFIER_CAPS ) & mod ? 'Z' : 'z' );
        default:
            break;
        }
...
#error The event types used require at least SDL 2.0.5
        ...
        static const char * getKeyName( const engine4heroes::Key key )
        {
            if ( key == engine4heroes::Key::KEY_MOUSE_BUTTON_BACKWARD ) {
                return "Mouse Backward";
            }

            if ( key == engine4heroes::Key::KEY_MOUSE_BUTTON_FORWARD ) {
    ...
    private:
        ...
        {
            int32_t modifier = engine4heroes::KeyModifier::KEY_MODIFIER_NONE;
            if ( sdlModifier & KMOD_CTRL ) {
                modifier |= engine4heroes::KeyModifier::KEY_MODIFIER_CTRL;
            }
            if ( sdlModifier & KMOD_SHIFT ) {
                modifier |= engine4heroes::KeyModifier::KEY_MODIFIER_SHIFT;
            }
            if ( sdlModifier & KMOD_ALT ) {
                modifier |= engine4heroes::KeyModifier::KEY_MODIFIER_ALT;
            }
            if ( sdlModifier & KMOD_CAPS ) {
                modifier |= engine4heroes::KeyModifier::KEY_MODIFIER_CAPS;
            }
            if ( sdlModifier & KMOD_NUM ) {
                modifier |= engine4heroes::KeyModifier::KEY_MODIFIER_NUM;
            }

            return modifier;
        }

        static int getSDLKey( const engine4heroes::Key key )
        {
            switch ( key ) {
            case engine4heroes::Key::NONE:
            case engine4heroes::Key::LAST_KEY:
                return SDLK_UNKNOWN;
            case engine4heroes::Key::KEY_BACKSPACE:
                return SDLK_BACKSPACE;
            case engine4heroes::Key::KEY_ENTER:
                return SDLK_RETURN;
            case engine4heroes::Key::KEY_ESCAPE:
                return SDLK_ESCAPE;
            case engine4heroes::Key::KEY_SPACE:
                return SDLK_SPACE;
            case engine4heroes::Key::KEY_EXCLAIM:
            ...
            case engine4heroes::Key::KEY_QUOTE:
                return SDLK_QUOTE;
            case engine4heroes::Key::KEY_BACKQUOTE:
            ...
            case engine4heroes::Key::KEY_LEFT_ALT:
                return SDLK_LALT;
            case engine4heroes::Key::KEY_RIGHT_ALT:
                return SDLK_RALT;
            case engine4heroes::Key::KEY_LEFT_CONTROL:
                return SDLK_LCTRL;
            case engine4heroes::Key::KEY_RIGHT_CONTROL:
                return SDLK_RCTRL;
            case engine4heroes::Key::KEY_LEFT_SHIFT:
                return SDLK_LSHIFT;
            case engine4heroes::Key::KEY_RIGHT_SHIFT:
                return SDLK_RSHIFT;
            case engine4heroes::Key::KEY_TAB:
                return SDLK_TAB;
            case engine4heroes::Key::KEY_DELETE:
                return SDLK_DELETE;
            case engine4heroes::Key::KEY_PAGE_UP:
                return SDLK_PAGEUP;
            case engine4heroes::Key::KEY_PAGE_DOWN:
                return SDLK_PAGEDOWN;
            case engine4heroes::Key::KEY_F1:
                return SDLK_F1;
            case engine4heroes::Key::KEY_F2:
                return SDLK_F2;
            case engine4heroes::Key::KEY_F3:
                return SDLK_F3;
            case engine4heroes::Key::KEY_F4:
                return SDLK_F4;
            case engine4heroes::Key::KEY_F5:
                return SDLK_F5;
            case engine4heroes::Key::KEY_F6:
                return SDLK_F6;
            case engine4heroes::Key::KEY_F7:
                return SDLK_F7;
            case engine4heroes::Key::KEY_F8:
                return SDLK_F8;
            case engine4heroes::Key::KEY_F9:
                return SDLK_F9;
            case engine4heroes::Key::KEY_F10:
                return SDLK_F10;
            case engine4heroes::Key::KEY_F11:
                return SDLK_F11;
            case engine4heroes::Key::KEY_F12:
                return SDLK_F12;
            case engine4heroes::Key::KEY_LEFT:
                return SDLK_LEFT;
            case engine4heroes::Key::KEY_RIGHT:
                return SDLK_RIGHT;
            case engine4heroes::Key::KEY_UP:
                return SDLK_UP;
            case engine4heroes::Key::KEY_DOWN:
                return SDLK_DOWN;
            case engine4heroes::Key::KEY_0:
                return SDLK_0;
            case engine4heroes::Key::KEY_1:
            ...
            case engine4heroes::Key::KEY_Z:
                return SDLK_z;
            case engine4heroes::Key::KEY_PRINT:
            ...
            case engine4heroes::Key::KEY_KP_PLUS:
                return SDLK_KP_PLUS;
            case engine4heroes::Key::KEY_KP_ENTER:
                return SDLK_KP_ENTER;
            case engine4heroes::Key::KEY_KP_EQUALS:
                return SDLK_KP_EQUALS;
            case engine4heroes::Key::KEY_HOME:
                return SDLK_HOME;
            case engine4heroes::Key::KEY_END:
                return SDLK_END;
            case engine4heroes::Key::KEY_MOUSE_BUTTON_BACKWARD:
                return SDL_BUTTON_X1;
            case engine4heroes::Key::KEY_MOUSE_BUTTON_FORWARD:
        ...
        static engine4heroes::Key getKeyFromSDL( int sdlKey )
        {
            ...
            static std::map<int, engine4heroes::Key> sdlValueToKey;
        ...
        static void onMouseButtonEvent( LocalEvent & eventHandler, const SDL_MouseButtonEvent & button )
        {
            ...
            case SDL_BUTTON_X1:
                ...
                eventHandler.onKeyboardEvent( engine4heroes::Key::KEY_MOUSE_BUTTON_BACKWARD, 0,
            ...
            case SDL_BUTTON_X2:
                ...
                eventHandler.onKeyboardEvent( engine4heroes::Key::KEY_MOUSE_BUTTON_FORWARD, 0,
                                              ( button.state == SDL_PRESSED ) ? LocalEvent::KeyboardEventState::KEY_DOWN : LocalEvent::KeyboardEventState::KEY_UP );
                return;
            default:
        ...
        {
            const engine4heroes::Key key = getKeyFromSDL( event.keysym.sym );
            if ( key == engine4heroes::Key::NONE ) {
...
bool LocalEvent::HandleEvents( const bool sleepAfterEventProcessing /* = true */, const bool allowExit /* = false */ )
{
    ...
    const engine4heroes::Time eventProcessingTimer;
    ...
    if ( sleepAfterEventProcessing ) {
        if ( renderRoi != engine4heroes::Rect() ) {
...
void LocalEvent::onTouchFingerEvent( const TouchFingerEventType eventType, const int64_t touchId, const int64_t fingerId, engine4heroes::PointBase2D<float> position )
{
    ...
    if ( eventFingerId == _fingerIds.first ) {
        ...
        const engine4heroes::Size screenResolution = engine4heroes::engine().getCurrentScreenResolution(); // current resolution of screen
        const engine4heroes::Rect windowRect = engine4heroes::engine().getActiveWindowROI(); // scaled (logical) resolution
...
void LocalEvent::ProcessControllerAxisMotion()
{
    ...
    if ( _controllerRightXAxis != 0 || _controllerRightYAxis != 0 ) {
        ...
        if ( _controllerRightXAxis < 0 ) {
            _currentKeyboardValue = engine4heroes::Key::KEY_LEFT;
        }
        else if ( _controllerRightXAxis > 0 ) {
            _currentKeyboardValue = engine4heroes::Key::KEY_RIGHT;
        }
        else if ( _controllerRightYAxis < 0 ) {
            _currentKeyboardValue = engine4heroes::Key::KEY_UP;
        }
        else if ( _controllerRightYAxis > 0 ) {
            _currentKeyboardValue = engine4heroes::Key::KEY_DOWN;
        }
    }
...
void LocalEvent::onMouseMotionEvent( engine4heroes::Point position )
{
    setStates( MOUSE_MOTION );
...
void LocalEvent::onMouseButtonEvent( const bool isPressed, const MouseButtonType buttonType, engine4heroes::Point position )
{
    if ( isPressed ) {
        _mouseButtonLongPressDelay.reset();
...
bool LocalEvent::MouseClickLeft( const engine4heroes::Rect & area )
{
    if ( !( _actionStates & MOUSE_RELEASED ) ) {
        return false;
    }
...
bool LocalEvent::MouseClickRight( const engine4heroes::Rect & area )
{
    if ( !( _actionStates & MOUSE_RELEASED ) ) {
        return false;
    }
...
bool LocalEvent::MouseLongPressLeft( const engine4heroes::Rect & rt )
{
    if ( !( _actionStates & MOUSE_PRESSED ) ) {
        return false;
    }
