...
### Developing engine4heroes engine

[![Build Status](https://github.com/ihhub/engine4heroes/actions/workflows/push.yml/badge.svg)](https://github.com/ihhub/engine4heroes/actions)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=ihhub_engine4heroes&metric=bugs)](https://sonarcloud.io/dashboard?id=ihhub_engine4heroes)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=ihhub_engine4heroes&metric=code_smells)](https://sonarcloud.io/dashboard?id=ihhub_engine4heroes)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=ihhub_engine4heroes&metric=duplicated_lines_density)](https://sonarcloud.io/dashboard?id=ihhub_engine4heroes)
